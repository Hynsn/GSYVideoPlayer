...
import com.example.gsyvideoplayer.fragment.VideoFragment2;
 ...
 * 简单详情实现模式1
 */
public class SimpleDetailActivityMode3 extends GSYBaseActivityDetail<ListGSYVideoPlayer> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_detail_player3);
...
//        initVideoBuilderMode();
    ...
    public void replace() {
        Fragment newFragment = new VideoFragment2();
